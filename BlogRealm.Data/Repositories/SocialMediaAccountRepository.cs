...
{
    public class SocialMediaAccountRepository : Repository<SocialMediaAccount>, ISocialMediaAccountRepository
    {
        public SocialMediaAccountRepository(BlogRealmDbContext context)
            : base(context)
        { }
